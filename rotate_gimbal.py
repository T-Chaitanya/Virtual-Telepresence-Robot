...
pi_hw.hardware_PWM(13, 50, 0)  #vertical = 35
pi_hw.hardware_PWM(19, 50, 0)  #horizontal   = 37
...
while True:
    ...
    pi_hw.hardware_PWM(19, 50, int(duty_x))  
    #time.sleep(2)
    duty_y= setAngle(-y_theta) * 10000
    pi_hw.hardware_PWM(13, 50, int(duty_y))  
